const pdfTemplate = ({
  ...
  return `
      ...
      <div>
        <img style="height: 50px; width: 100px" src="https://res.cloudinary.com/dg35zrfnl/image/upload/v1703322240/ewyxkvvjndsvwugbkl2k.png" />
      ...
      <div class="status" style="margin-top: -200px">
        ...
        <p style="font-size: 9px">${new Date(
          issuedDate
